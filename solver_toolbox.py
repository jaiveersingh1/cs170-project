...
class ILPSolver(BaseSolver):
    def solve(self, list_of_locations, list_of_homes, starting_car_location, adjacency_matrix, params=[]):
        ...
        places = ['Dwinelle', 'Soda', 'Cory', 'Blum', 'Etcheverry',
                'Campanile', 'Wheeler', 'Memorial Stadium',
                'Li Ka Shing', 'Main Stacks', 'Jacobs', 'Wurster',
                'Sutardja Dai', 'Barrows']
